...
/// A Dart object that owns a native Core ML object through an opaque handle.
///
...
abstract base class NativeResource {
  ...
  NativeResource(this._handle) : bindings = CoreMLBindings.instance {
