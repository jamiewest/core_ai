// Pigeon schema for the apple_vision_native plugin.
//
// Regenerate with:
//   dart run pigeon --input pigeons/apple_vision_native_api.dart
...
@ConfigurePigeon(
  PigeonOptions(
    ...
    swiftOut:
        'darwin/apple_vision_native/Sources/apple_vision_native/Messages.g.swift',
    swiftOptions: SwiftOptions(errorClassName: 'AppleVisionPigeonError'),
    dartPackageName: 'apple_vision_native',
